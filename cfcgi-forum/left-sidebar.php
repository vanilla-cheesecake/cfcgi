...
?>
           <div class="sidebar">
            <ul style="list-style:none;">
                <li><i class="fa fa-hashtag" style="color:#50b7f5;font-size:10px;"></i></li>
                ...
                <li style="padding:10px 40px;"><button class="sidebar_hashtag button addHashtagBtn" style="outline:none;">Hashtag</button></li>
                <?php }?>
                <?php if ( $getFromU->loggedIn() === false ) {
                ?>
                <a href='<?php echo BASE_URL; ?>' style="text-decoration:none;"><li style="padding:10px 40px;"><button class="sidebar_hashtag button" style="outline:none;">Login</button></li></a>
                <?php }?>
            </ul>
            <ul>
               <?php if ( $getFromU->loggedIn() === true ) {
