        ...
        <div class="main">
            <div class=''>
                <div class=''>
                        ...
                        <div class='profile-body'>
                            ...
                            <div class="profile-text">
                                ...
                                <div class="profile-bio">
                                    <h5><?php echo $getFromT->getTagLinks($profileData->bio); ?></h5>
                                </div>
                                ...
                                <div class="profile-follow mt-2 d-flex">
                                    ...
                                    <?php echo $getFromT->countTag($profileId); ?>
                                    <a style="color:rgb(91, 112, 131);">Hashtag</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='hashtag'>
                        <?php $getFromT->hashtag( $user_id, 100 );
                        ?>
                    </div>
                    <!--HASHTAG SHOW WRAPPER-->
